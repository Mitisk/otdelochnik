...
<p id="count-client" >Пользователи - <strong><?php echo $result_count; ?></strong></p>
</div>
<?php
...
do
{
 ...
 <p class="client-email" ><strong>'.$row["login"].' - '.$row["mail"].'</strong></p>
 <p class="client-links" ><a class="delete" rel="clients.php?id='.$row["id"].'&action=delete" >Удалить</a></p>
 
 
 <ul>
 <li><strong>E-Mail</strong> - '.$row["mail"].'</li>
